...
class SplashWindow(QDialog):
    ...
    def _build_ui(self):
        ...
        self.logo_lbl.setStyleSheet("border-radius:12px; background: #FFFFFF;")
        self._load_logo()
    ...
    def _load_logo(self):
        ...
        if pix and not pix.isNull():
            ...
            self.logo_lbl.setStyleSheet(self.logo_lbl.styleSheet() + "color: #7A5ACB; font-weight:900;")
            f = QFont()
