...
class PreviewWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("#preview_widget { background: #ffffff; border: 1px solid #DDD; }")
...
class ProductosWindow(QDialog):
    ...
    def _build_ui(self):
        ...
        self.codigo_edit.setStyleSheet("background:#F7F7F7;")
        ...
        self.bcv_lbl.setStyleSheet("font-weight:600; color:#5E3DB3;")
        grid.addWidget(self.bcv_lbl, 6, 0, 1, 2)
        
        info_base = QLabel("💡 Todos los productos se guardan en $ como base")
        info_base.setStyleSheet("font-size:11px; color:#666; font-style:italic;")
        ...
        self.precio_usd_lbl.setStyleSheet("font-weight:700; color:#2D7A2D;")  # Verde para destacar
        self.precio_bs_lbl.setStyleSheet("font-weight:600; color:#666;")      # Gris para secundario
        ...
        preview_frame.setStyleSheet("QFrame { border:1px solid #DDD; background: #FFF; }")
