...
class RegistroGeneralWindow(QDialog):
    ...
    def __init__(self, parent=None, departamento: str = None):
        ...
        title.setStyleSheet("font-size:16px; font-weight:600; color:#5E3DB3;")
        ...
        info_lbl.setStyleSheet("font-size:11px; color:#666; font-style:italic; padding:4px;")
        ...
        self.info_lbl.setStyleSheet("font-weight:600; color:#333;")
