...
class EntradasWindow(QDialog):
    ...
    def _build_ui(self):
        ...
        self.abrir_carrito_btn.setStyleSheet("background:#2E8B57; color:white;")
        ...
        self.registrar_btn.setStyleSheet("background:#8E6BE6; color:white;")
        ...
        self.export_pdf_btn.setStyleSheet("background:#8E6BE6; color:white;")
    ...
    def cargar_tabla(self, limit=300):
        ...
        try:
            ...
            for r in rows:
                ...
                del_btn.setStyleSheet("background:#E25555; color:white;")
