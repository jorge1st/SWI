...
class VentasIntegradoWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        self.lbl_total.setStyleSheet("font-size:16px; font-weight:700; color:#2D7A2D;")
        ...
        self.finalize_btn.setStyleSheet("background:#2D7A2D; color:white; font-weight:800; padding:10px;")
