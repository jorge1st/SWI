...
class DashboardWindow(QMainWindow):
    def __init__(self):
        ...
        for b, key in sidebar_buttons:
            ...
            b.setStyleSheet("background:transparent; color:white; text-align:left; padding:10px; font-size:15px; font-weight:600;")
            b.setFlat(True)
        ...
        self.bcv_box = QFrame()
        self.bcv_box.setStyleSheet("""
            QFrame {
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #FAF7FF, stop:1 #F0E9FF);
                border-radius: 14px;
        ...
        bcv_label.setStyleSheet("color:#5E3DB3; font-weight:600; font-size:13px;")
        self.bcv_value = QLabel("--")
        self.bcv_value.setStyleSheet("font-size:18px; font-weight:700; color:#333;")
        self.bcv_time = QLabel("")
        self.bcv_time.setStyleSheet("font-size:11px; color:gray;")
        ...
        try:
            self.menu_title.setStyleSheet(f"color:#6B4ED6;font-size:{scale_px(22)}px;font-weight:800;letter-spacing:1px;")
            self.menu_title.setFixedHeight(scale_px(42))
        except Exception:
            self.menu_title.setStyleSheet("color:#6B4ED6;font-size:22px;font-weight:800;letter-spacing:1px;")
        ...
        try:
            self.dept_title.setStyleSheet(f"color:#6B4ED6;font-size:{scale_px(22)}px;font-weight:800;letter-spacing:1px;")
            self.dept_title.setFixedHeight(scale_px(42))
        except Exception:
            self.dept_title.setStyleSheet("color:#6B4ED6;font-size:22px;font-weight:800;letter-spacing:1px;")
